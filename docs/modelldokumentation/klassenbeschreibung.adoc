...
Die Klassenbeschreibung erfolgt auf der Grundlage des Publikationsmodells. Dies deshalb, weil das Publikationsmodell den vollständigen Attributumfang aufweist.
