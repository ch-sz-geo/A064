...
| Beteiligte | Bernhard Roth (BR), AWN + 
Kuno Epper (Kep), AGI
| Status a| - [x] Entwurf 
...
| [[doc-05]] [05] | SilvaProtect-CH: Schutzwald in der Schweiz - Vom Projekt SilvaProtect-CH zum harmonisierten Schutzwald +
https://www.newsd.admin.ch/newsd/message/attachments/29559.pdf | Bundesamt für Umwelt +
BAFU | 2013
|===
====
